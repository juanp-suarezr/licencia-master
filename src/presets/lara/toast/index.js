export default {
  ...
  container: ({ props }) => ({
    class: [
      ...
      // Colors
      {
        'bg-primary dark:bg-blue-500/20': props.message.severity == 'info',
        ...
        'bg-danger dark:bg-danger': props.message.severity == 'error',
      },
      {
        'border-meta-5 dark:border-blue-400': props.message.severity == 'info',
      ...
      {
        'bodydark dark:text-blue-300': props.message.severity == 'info',
